    ...
    <div className={cn("relative", className)}>
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-2xl">
          <div className="bg-white/10 flex items-center justify-center rounded-full backdrop-blur-md  h-28 w-28">
            <div
              className={`flex items-center justify-center bg-gradient-to-b from-white/30 to-white shadow-md rounded-full  h-20 w-20 transition-all ease-out duration-200 relative group-hover:scale-[1.2] scale-100`}
            >
              <Play
